...
export default function About() {
  ...
  return (
    <React.Fragment>
          ...
          <div className="row text-center">
            ...
            <div className="col-lg-4 mb-4">
              <div className="mission-card p-4 h-100">
                ...
                <h3>Our Approach</h3>
                <p>
                  <strong>Connect. Volunteer. Grow.</strong> Real impact with real people through curated opportunities and support for NGOs.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 mb-4">
              <div className="mission-card p-4 h-100">
                ...
                <p>
                  <strong>VolunTier_Hub</strong> makes it easy for individuals to find projects that truly align with their skills, interests, and availability. Using advanced search filters based on location, category, volunteers can identify opportunities where they can make the most impact. This ensures every effort contributes to meaningful social change.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 mb-4">
              <div className="mission-card p-4 h-100">
                ...
                <p>
                  <strong>Volunteers</strong> can register directly on the platform, while <strong>host organizations </strong> can manage registrations, update project details, and track volunteer participation efficiently. This centralization reduces confusion and makes project management more organized and effective.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 mb-4">
              <div className="mission-card p-4 h-100">
                ...
                <p>
                  The <strong>Volunteer Dashboard</strong> gives individuals a simple, personalized space to explore opportunities, registrations, track their activities, and stay updated with notifications. The <strong>Host Dashboard</strong> enables NGOs and non-profits to create and manage projects, monitor volunteer participation, and access insights on engagement, making coordination smoother and more effective.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="what-we-do-section py-5" style={{ background: "#f4f4f4" }}>
        <div className="container">
