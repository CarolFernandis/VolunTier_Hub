...
import "./CleanUp.css"; // Separate CSS file
...
const experienceData = {
  ...
  details: {
    locationName: "Hostel in Gorgaoni, Mumbai",
    title: "Volunteer in Community Clean",
    header: "About This Experience",
    intro:
      "Are you passionate about preserving nature, rolling up your sleeves, and creating a pristine environment? Join us for an exchange helping with the clean-up  of Gorgaon, Mumbai.",
    tasks: ["Content creation", "Digital marketing"],
    offer: [
      "Free accommodation and meals",
      "A chance to experience the breathtaking beauty of Gorgaon",
